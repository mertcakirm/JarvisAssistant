...
file_controller
  action: "write" | "create_file" | "read" | "list" | "delete" | "move" | "copy" | "find" | "disk_usage" | "empty_trash" (required)
...
calendar_control
  action: "list" | "add" | "delete" (required)
  date_filter: string (for list: "today", "tomorrow", "all", or "YYYY-MM-DD")
  title_filter: string (for list: filter by title)
  title: string (for add/delete: event title)
  start_time: string (for add: "YYYY-MM-DD HH:MM:SS")
  end_time: string (for add: "YYYY-MM-DD HH:MM:SS")
  calendar_name: string (for add: specific calendar)
